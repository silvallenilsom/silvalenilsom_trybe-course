...
SELECT UCASE('trybe');
-- Faça uma query que transforme a frase
-- 'Você já ouviu falar do DuckDuckGo?' em
-- 'Você já ouviu falar do Google?' .
SELECT REPLACE
('Você já ouviu falar do DuckDuckGo?', 'DuckDuckGo', 'Google');
...
-- Por fim, padronize a string
-- 'RUA NORTE 1500, SÃO PAULO, BRASIL'
